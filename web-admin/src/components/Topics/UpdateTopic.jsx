...
const UpdateTopic = (props) => {
    ...
    useEffect(() => {
        const getTopic = async () => {
            try {
                const res = await AxiosInstance().get(`/get-topic-detail.php?topic_id=${id}`)
                console.log(res);
                if (res.status) {
                    setName(res.topic?.name);
                    setDescription(res.topic?.description);
                }
            } catch (error) {
                console.log(error);
            }
            ...
            .then(async (will) => {
                if (will) {
                    try {
                        ...
                        const res = await AxiosInstance().post(`/update-topics.php?id=${id}`, data)
                        console.log(res);
                        if (res.status) {
                            ...
                            setTimeout(() => {
                                window.location.href = '/list-topics';
                            }, 2000);
                        } else {
                                    ...
                                    <FormControl isRequired>
                                        ...
                                        <InputGroup>
                                            ...
                                            <Input
                                                ...
                                                type="text"
                                                name="title" placeholder="Tên chủ đề" />
                                        </InputGroup>
                                    </FormControl>
