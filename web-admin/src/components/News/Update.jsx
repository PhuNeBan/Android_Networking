...
const Update = (props) => {
  ...
  //get list topic when load page
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await AxiosInstance().get("/get-topics.php");
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await AxiosInstance().get(
          `/get-news-detail.php?news_id=${id}`
        );
        console.log(res);
        setTitle(res.news?.title);
        setContent(res.news?.content);
        setPreviewImage(res.news?.image);
        setTopic_id(res.news?.topic_id);
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    swal({
      ...
      text: "Cập nhật lại dữ liệu trên hệ thống!",
      icon: "warning",
      buttons: true,
      dangerMode: true,
    }).then(async (will) => {
                ...
                <VStack spacing={5}>
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input
                        ...
                        type="text"
                        name="title"
                        placeholder="Đổi tiêu đề bài viết"
                      />
                    </InputGroup>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    ...
                    <Stack spacing={3}>
                      <Select
                        value={topic_id}
                        onChange={(event) => setTopic_id(event.target.value)}
                        variant="filled"
