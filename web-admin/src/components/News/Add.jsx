...
const Add = (props) => {
  ...
  const handleSubmit = async (e) => {
    swal({
      ...
      text: "Thêm tin mới vào hệ thống!",
      icon: "warning",
      buttons: true,
      dangerMode: true,
    }).then(async (will) => {
      if (will) {
        try {
          //validate form
          if (!title || !content || !image || !topic_id) {
          ...
          e.preventDefault();
          //preventDefault là để khi submit form thì nó không load lại trang
          const data = {
            title,
            content,
            image,
          ...
          const res = await AxiosInstance().post("/insert-news.php", data);
          console.log(res);
          if (res.status) {
